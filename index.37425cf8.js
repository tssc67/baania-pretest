 ...
 * @license: MIT
 */ !function(t1, r1, e1) {
    var n1 = function(t2, e) {
        this.t = this.e(t2) ? r1.querySelectorAll(t2) : [
            t2
        ], this.n = [], this.i = e, this.r = [], this.o(), this.destroy = function() {
            this.u(function(t) {
    ...
    n1.prototype = {
        ...
        T: function(t, e) {
            var n = "string" == typeof t ? r1.createElement(t) : t;
            for(var i in e = e || {})e.hasOwnProperty(i) && n.setAttribute(i, e[i]);
            return n;
        },
        C: function() {
            var t3 = [].slice.call(arguments), n = t3[0], i = t3.slice(1);
        ...
        y: function(t) {
            var e = 'label[for="' + t.getAttribute("id") + '"]', n = this.t[this.S].querySelectorAll(e);
            return 1 < n.length && (n = t.parentNode.querySelectorAll(e)), 1 === n.length && n[0];
        },
        q: function(t, e) {
            var n = t.textContent.replace("*", "").trim(), i = e.getAttribute("placeholder");
        ...
        P: function(t) {
            var e = "INPUT" === t.tagName && !this.n[this.S].inputRegex.test(t.getAttribute("type")), n = "SELECT" === t.tagName && null !== t.getAttribute("multiple");
            return t.getAttribute("id") && !e && !n;
        },
        u: function(t, e) {
            for(var n = this, i = 0; i < n.t.length; ++i){
                if (void 0 === n.r[i]) {
                    var r = n.C({}, n.c, n.i, n.t[i].getAttribute("data-options")), o = ":not(" + r.exclude.split(/[\s,]+/).join("):not(") + ")";
        ...
        s: function(t4) {
            var e = this.n[this.S].prefix, n = t4.className.split(" ").filter(function(t) {
                return 0 !== t.lastIndexOf(e, 0);
            });
            t4.className = n.join(" ").trim();
        },
        a: function(t) {
            var e = t.parentNode;
            if (this.j(t)) {
                for(var n = r1.createDocumentFragment(); e.firstElementChild;){
        ...
        O: function(t) {
            var e = "data-placeholder", n = t.getAttribute(e);
        ...
        g: function(t, e) {
            var n = this, i = e.getAttribute("placeholder");
        ...
        return n1;
    }) : "object" == typeof module && module.exports ? module.exports = n1 : t1.FloatLabels = n1;
}(window, document);

//# sourceMappingURL=index.37425cf8.js.map
